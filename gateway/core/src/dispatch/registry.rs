...
impl DispatchRead<GatewayContext> for registry::ListDeployments {
    fn dispatch(
        request: Self::Input,
        ctx: GatewayContext,
...
impl DispatchRead<GatewayContext> for registry::GetDeployment {
    fn dispatch(
        request: Self::Input,
        ctx: GatewayContext,
    ) -> BoxFuture<'static, GatewayResult<Self::Output>> {
...
impl DispatchRead<GatewayContext> for registry::ListVersions {
    fn dispatch(
        request: Self::Input,
        ctx: GatewayContext,
    ) -> BoxFuture<'static, GatewayResult<Self::Output>> {
...
impl DispatchRead<GatewayContext> for registry::ListDeploymentsByKind {
    fn dispatch(
        request: Self::Input,
        ctx: GatewayContext,
    ) -> BoxFuture<'static, GatewayResult<Self::Output>> {
...
impl PlanWrite<GatewayContext> for registry::AddVersion {
    fn plan(
        request: Self::Input,
        ctx: GatewayContext,
...
impl PlanWrite<GatewayContext> for registry::Deploy {
    fn plan(
        request: Self::Input,
        ctx: GatewayContext,
    ) -> BoxFuture<'static, GatewayResult<OperationPlan>> {
...
impl PlanWrite<GatewayContext> for registry::RemoveVersion {
    fn plan(
        request: Self::Input,
        ctx: GatewayContext,
    ) -> BoxFuture<'static, GatewayResult<OperationPlan>> {
