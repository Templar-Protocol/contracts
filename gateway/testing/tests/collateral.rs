//! Ported from `contract/market/tests/collateral.rs` (the
//! `excessive_collateral_withdrawal` case) onto the gateway harness. The
//! concurrent `collateral_withdrawal` race test is not ported here.
