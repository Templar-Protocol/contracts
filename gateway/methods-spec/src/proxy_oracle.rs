...
read_method_spec!(
    ...
    "proxyOracle.listProxies": ListProxies -> ListProxiesResult
);
...
read_method_spec!(
    ...
    "proxyOracle.getProxy": GetProxy -> GetProxyResult
);
...
read_method_spec!(
    ...
    "proxyOracle.priceFeedExists": PriceFeedExists -> PriceFeedExistsResult
);
