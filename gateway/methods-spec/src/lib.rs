...
macro_rules! for_each_write_method {
    ($callback:ident) => {
        ...
        $callback!($crate::account::DeleteKey);
        ...
        $callback!($crate::owner::ProposeOwner);
        $callback!($crate::owner::AcceptOwner);
        $callback!($crate::owner::RenounceOwner);
