...
//! not something the contract can infer — the operator names it, and naming the wrong one fails
//! to deserialize rather than misreading, since the layouts differ by a whole field and borsh
//! rejects both leftover and missing bytes.
