...
use templar_universal_account::{
    authentication::passkey::{
        self, data::AuthenticatorData, MessageWithSignatureWithUncheckedHashes, Passkey,
    },
...
pub fn main() {
    let message: MessageWithSignatureWithUncheckedHashes<Vec<Transaction>> = MessageWithSignatureWithUncheckedHashes {
        authenticator_data: AuthenticatorData::from_str(
            "49960de5880e8c687434170f6476605b8fe4aeb9a28632c7995cf3ba831d97631d00000000",
        )
        .unwrap(),
        message: passkey::Message(r#"{"parameters":{"block_height":"123456","index":"0","nonce":"1"},"account_id":"my-universal-account.testnet","payload":[{"receiver_id":"alice.testnet","actions":[{"Transfer":{"amount":"1000000000000000000000000"}}]}]}"#.parse().unwrap()),
