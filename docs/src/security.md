...
Important security notices will be posted on the official Discord server, Telegram channel, and X (Twitter) account. For more information, refer to [`SECURITY.md`](https://github.com/Templar-Protocol/contracts/blob/dev/SECURITY.md).
