...
- `contract/pyth-pro` (`templar-pyth-pro-verifier` / `templar-pyth-pro-adapter-contract`)
  ...
  Read/inspect: `contract/pyth-pro/verifier/src/verify.rs`, `contract/pyth-pro/contract/src/lib.rs`, `contract/pyth-pro/contract/src/events.rs` (`FeedData` + its price projections live in `common/src/oracle/lazer.rs`).
