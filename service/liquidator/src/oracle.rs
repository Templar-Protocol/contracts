...
impl OracleFetcher {
    ...
    fn collect_pyth_targets_from_source(
        ...
        match source {
            ...
            // Lazer prices are pushed by the gateway (which holds the Lazer
            // payload source), not the liquidator — same division of labor as
            // RedStone above.
            Source::Request(OracleRequest::Lazer(_)) => {}
