...
"#,
    ...
    ///
    /// A missing allowance row is provisioned with `starting_allowance` as part
    /// of the same transaction, so a first-seen account is charged like any
    /// other rather than failing the lock.
    ///
    /// # Errors
    ///
    ...
    pub async fn lock_pending(
        ...
        // Provision a first-seen account before locking its row, same transaction.
        sqlx::query!(
            r#"
INSERT INTO
