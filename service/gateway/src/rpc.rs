    ...
    ContextType: HasNearClient + ProvidesPythSource + ProvidesRedStoneSource + std::marker::Unpin,
{
    ...
    builder.register_read::<proxy_oracle_governance::NextProposalId, MethodsDispatch>()?;
    builder.register_read::<proxy_oracle_governance::ProposalCount, MethodsDispatch>()?;
    builder.register_read::<proxy_oracle_governance::GetOperationTtl, MethodsDispatch>()?;
    builder.register_read::<proxy_oracle_governance::ListProposals, MethodsDispatch>()?;
    builder.register_read::<proxy_oracle_governance::GetProposal, MethodsDispatch>()?;
    builder.register_write::<proxy_oracle_governance::CreateProposal, MethodsDispatch>()?;
    builder.register_write::<proxy_oracle_governance::CancelProposal, MethodsDispatch>()?;
    builder.register_write::<proxy_oracle_governance::ExecuteProposal, MethodsDispatch>()?;
